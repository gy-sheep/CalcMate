...
> **마지막 완료**: 설정 화면 (다크 모드 + 계산기 관리) 및 메인 카드 스와이프 숨기기

### Phase 14: 설정 화면 — 나머지 섹션
- [ ] 3번 섹션: 계산기 기본값 (환율 기준 통화, BMI 단위 — 로케일 자동 감지 + 수동 재정의)
- [ ] 4번 섹션: 조작 (버튼 진동 피드백 토글)
- [ ] 5번 섹션: 앱 정보 (버전, 오픈소스 라이선스, 개인정보처리방침, 문의하기)
