/// 음력 설날(정월 초하루)의 양력 날짜 룩업 테이블 (1900 ~ 2050).
/// 용도: 출생일이 설날 이전이면 전년도 띠로 보정.
const Map<int, (int, int)> kLunarNewYearDates = {
...
/// [year]에 해당하는 설날의 양력 [DateTime]을 반환한다. 없으면 null.
DateTime? lunarNewYearDate(int year) {
  final entry = kLunarNewYearDates[year];
  if (entry == null) return null;
  return DateTime(year, entry.$1, entry.$2);
}
