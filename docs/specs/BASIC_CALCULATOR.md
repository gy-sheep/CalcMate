...
### 수식 표시 영역도 좌우 스크롤 적용 — 날짜: 2026-03-02
**상태**: `수정완료`

---

### 수식 표시 영역의 내용이 너무 길어져 화면을 벗어나는 경우 연산 기호를 기준으로 줄바꿈하고 두번째 줄에 연산 기호 표시 — 날짜: 2026-03-21
**상태**: `수정완료`

---

### 입력값 / 결과 표시 영역은 숫자를 길게 입력해 표시 영역을 벗어나게 되면 좌우 스크롤이 적용되어 스크롤하며 확인할 수 있도록 수정 — 날짜: 2026-03-21
**상태**: `수정완료`
